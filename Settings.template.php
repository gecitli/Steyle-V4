...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			'id' => 'enable_silder',
			'label' => $txt['enable_silder'],
		),
		array(
			'id' => 'silder_index',
			'label' => $txt['silder_index'],
		),
		array(
			'id' => 'silder_img',
			'label' => $txt['silder_img_url'],
			'type' => 'text',
		),
		array(
			'id' => 'silder_title',
			'label' => $txt['silder_title'],
			'type' => 'text',
		),
		array(
			'id' => 'silder_description',
			'label' => $txt['silder_description'],
			'type' => 'text',
		),
		array(
			'id' => 'silder_url',
			'label' => $txt['silder_url'],
			'type' => 'text',
		),
		'',
		array(
